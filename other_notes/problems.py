# how to use generater, the in deepth understanding, using yield

# regexr.com learn regular expressions here

# how to use memory related stardard library
...
# learn encoding adn decoding ,start with the exersie from the lpthw
